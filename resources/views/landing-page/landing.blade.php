  ...
  <div class="all-content">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5" id="col">
            <h1>Info</h1>
            <p></a><i class="fa-regular fa-envelope"></i>alezafazriliyadisudrajat@smkwikrama.sch.id</p>
            <p><i class="fa-solid fa-phone"></i>+6278657650</p>
    ...
    <footer id="footer">
      ...
      <div class="socail-links text-center">
        ...
        <a href="https://github.com/alezafazriliyadisudrajat/Cafe-Bdp.git"><i class="fa-brands fa-git hub"></i></a>
        <a href="https://www.instagram.com/aleza_2775/"><i class="fa-brands fa-instagram"></i><a/>
      </div>

      <div class="credits text-center">
        Dseigned By <a href="#"> <span>Aleza FS</span></a>
      </div>
